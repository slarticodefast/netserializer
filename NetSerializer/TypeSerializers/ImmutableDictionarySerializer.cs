...
public sealed class ImmutableDictionarySerializer : IStaticTypeSerializer
{
	public bool Handles(Type type)
	{
		return type.IsGenericType && type.GetGenericTypeDefinition() == typeof(ImmutableDictionary<,>);
	}
	...
	public MethodInfo GetStaticWriter(Type type)
	{
		...
		Debug.Assert(genTypeDef == typeof(ImmutableDictionary<,>));
	...
	public static void ReadPrimitive<TKey, TValue>(Serializer serializer, Stream stream, out ImmutableDictionary<TKey, TValue> value)
	{
		...
		var builder = new Dictionary<TKey, TValue>(kvpArray.Length);
